...
public:
	//bluker:服务器预留一个位置给玩家
	virtual bool __cdecl ServerAllocTable(IServerUserItem * pIServerUserItem);
	//bluker:是否是服务器预留的那个位子？
	//virtual bool __cdecl IsServerAllocTable(WORD wTableID,IServerUserItem * pIServerUserItem);
