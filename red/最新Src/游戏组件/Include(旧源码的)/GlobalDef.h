...
#define ServerDomain		TEXT("game.wjgames.com")

#define UrlQQShow			TEXT("http://"ServerDomain"/client/show.jsp?name=%s")

#define szProductName		TEXT("万金游娱乐")
...
#define szStationPage		TEXT("www.wjGames.com")
...
//数据加密密钥
const static DWORD g_dwPacketKey=0x7DD77DD7;
