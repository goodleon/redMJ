...
bool					CScoreCard::m_bLoad=false;					//加载标志
CSize					CScoreCard::m_CardSize;						//扑克大小
CSkinImage		CScoreCard::m_ImageCard;						//图片资源

bool					CUserScoreCard::m_bLoad=false;				//加载标志
CSize					CUserScoreCard::m_CardSize;					//扑克大小
CSkinImage		CUserScoreCard::m_ImageCard;					//图片资源
