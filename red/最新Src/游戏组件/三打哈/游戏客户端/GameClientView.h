#include "../../../共享组件/界面控件/TransButton.h"
...
#define IDM_SURRENDER				(WM_USER+105)						//投降消息
...
public:
	...
	TransButton						m_btSurrender;						//投降按钮
