...
protected:
	...
	BYTE							m_cbCardType[GAME_PLAYER];			//用户牌型
...
public:
	...
	//CHeapCard						m_HeapCard;							//堆立扑克

	//控件变量
protected:
	/*TransButton						m_btAddGold;						//下注按钮
	TransButton						m_btBegin;							//开始按钮
	TransButton						m_btGiveUp;							//放弃按钮
	TransButton						m_btGetCard;						//要牌按钮
	TransButton						m_btStop;							//停牌按钮
	TransButton						m_btDouble;							//双倍按钮
	TransButton						m_btCutCard;						//分牌按钮*/
