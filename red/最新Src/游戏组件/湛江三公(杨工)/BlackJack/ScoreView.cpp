...
//	dc.TextOut(140,38,pszScore,lstrlen(pszScore));
	...
	for (WORD i=0;i<CountArray(m_szUserName);i++)
	{
		...
		{
			dc.TextOut(80,(int)(wStation*22+50),m_szUserName[i]);
			_snprintf(szBuffer,sizeof(szBuffer),TEXT("%ld"),m_lScore[i]);
			dc.TextOut(160,(int)(wStation*22+50),szBuffer,lstrlen(szBuffer));
			wStation++;
		}
	}
	...
	if (wStation>0)
	{
		...
		dc.TextOut(80,(int)(wStation*22+50),pszTax,lstrlen(pszTax));
