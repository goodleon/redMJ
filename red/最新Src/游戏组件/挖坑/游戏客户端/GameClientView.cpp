...
int CGameClientView::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	//创建按钮
	m_btStart.Create(TEXT("开始"),WS_CHILD,CreateRect,this,IDC_START);
	m_btOutCard.Create(TEXT("出牌"),WS_CHILD,CreateRect,this,IDC_OUT_CARD);
	m_btPassCard.Create(TEXT("放弃"),WS_CHILD,CreateRect,this,IDC_PASS_CARD);
	m_btOneScore.Create(TEXT("１ 倍"),WS_CHILD,CreateRect,this,IDC_ONE_SCORE);
	m_btTwoScore.Create(TEXT("２ 倍"),WS_CHILD,CreateRect,this,IDC_TWO_SCORE);
	m_btThreeScore.Create(TEXT("３ 倍"),WS_CHILD,CreateRect,this,IDC_THREE_SCORE);
	m_btGiveUpScore.Create(TEXT("不叫"),WS_CHILD,CreateRect,this,IDC_GIVE_UP_SCORE);

	//设置按钮
	HINSTANCE hInstance=AfxGetInstanceHandle();
	m_btStart.SetButtonImage(IDB_VIEW_BUTTOM,hInstance,false);
	m_btOutCard.SetButtonImage(IDB_VIEW_BUTTOM,hInstance,false);
	m_btPassCard.SetButtonImage(IDB_VIEW_BUTTOM,hInstance,false);
	m_btOneScore.SetButtonImage(IDB_VIEW_BUTTOM,hInstance,false);
	m_btTwoScore.SetButtonImage(IDB_VIEW_BUTTOM,hInstance,false);
	m_btThreeScore.SetButtonImage(IDB_VIEW_BUTTOM,hInstance,false);
	m_btGiveUpScore.SetButtonImage(IDB_VIEW_BUTTOM,hInstance,false);
...
void CGameClientView::RectifyGameView(int nWidth, int nHeight)
{
	...
	if (m_bDeasilOrder==true)
	{
		...
		m_ptCavern[2].x=m_nXBorder+3;
		m_ptCavern[2].y=nHeight/2+5;
	}
	else
	{
	...
	m_ptCavern[1].y=nHeight-m_nXBorder-m_CavernSize.cy-5;
	...
	DeferWindowPos(hDwp,m_btStart,NULL,(nWidth-rcButton.Width())/2,nHeight-185-m_nYBorder,0,0,uFlags);
	DeferWindowPos(hDwp,m_btOutCard,NULL,nWidth/2-rcButton.Width()-10,nHeight-185-m_nYBorder,0,0,uFlags);
	DeferWindowPos(hDwp,m_btPassCard,NULL,nWidth/2+10,nHeight-185-m_nYBorder,0,0,uFlags);
	DeferWindowPos(hDwp,m_btOneScore,NULL,nWidth/2-rcButton.Width()*2-30,nHeight-185-m_nYBorder,0,0,uFlags);
	DeferWindowPos(hDwp,m_btTwoScore,NULL,nWidth/2-rcButton.Width()-10,nHeight-185-m_nYBorder,0,0,uFlags);
	DeferWindowPos(hDwp,m_btThreeScore,NULL,nWidth/2+10,nHeight-185-m_nYBorder,0,0,uFlags);
	DeferWindowPos(hDwp,m_btGiveUpScore,NULL,nWidth/2+30+rcButton.Width(),nHeight-185-m_nYBorder,0,0,uFlags);
	...
	m_ScoreView.SetWindowPos(NULL,(nWidth-rcControl.Width())/2,120,0,0,SWP_NOZORDER|SWP_NOSIZE);
