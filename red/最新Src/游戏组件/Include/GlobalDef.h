...
#pragma warning(disable:4800 4311 4312)


#define UserNumber		ULONG
#define UserMoney			LONG


#define ServerDomain		TEXT("www.lacogame.com")

#define UrlQQShow			TEXT("http://"ServerDomain"/client/show.jsp?name=%s")

#define szProductName		TEXT("金库游戏娱乐")

#define szLessMoney		TEXT("加入游戏至少需要 %ld 的游戏币才能游戏，现在就获得游戏币吗！")

//注册主键
#define szSystemRegKey		TEXT("wjGames")

//游戏主页
//#define szStationPage		TEXT(ServerDomain)
#define szStationPage		TEXT("www.lacogame.com")

#define PRIZE_GAME_ID		50000


#define CenterServerTitle TEXT("中心服务器")
#define LogonServerTitle TEXT("登录服务器")
#define szNoChairToSit TEXT("没有合适的位置，请稍后再试！")


//得到游戏框架对象
#define FrameDlg ((CGameClientDlg*)AfxGetMainWnd())

//数据加密密钥
const static DWORD g_dwPacketKey=0xBBBCCCDD;//0xC77CC77C;//0x6CC66CC6;
...
//#define MAIN_DLG_CLASSNAME				szSystemRegKey	
#define MAIN_DLG_CLASSNAME				TEXT("wjGamesPlaza")				//窗口注册名
...
//游戏进程发窗口句柄给大厅
#define WM_GAMECLIENT	WM_USER+188
#define MSG_SENDWND	1000
...
struct tagUserInfoHead
{
	...
	//用户游戏币
	tagUserScore						UserScoreInfo;						//游戏币信息
};
...
#define LEVEL_EXP_1				0
#define LEVEL_EXP_2				500
#define LEVEL_EXP_3				1500
#define LEVEL_EXP_4				4000
#define LEVEL_EXP_5				10000
#define LEVEL_EXP_6				20000
