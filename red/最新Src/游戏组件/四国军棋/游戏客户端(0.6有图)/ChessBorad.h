...
//位置定义
#define CHESS_WIDTH					22									//棋子宽度
#define CHESS_HEIGTH				22									//棋子高度
#define NODE_WIDTH					28									//结点宽度
#define NODE_HEIGTH					28									//结点高度

#define ARROW_WIDTH					22									//箭头宽度
#define ARROW_HEIGTH				22									//箭头高度
