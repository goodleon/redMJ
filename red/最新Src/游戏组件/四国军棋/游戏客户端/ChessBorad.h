...
//位置定义
#define CHESS_WIDTH					26									//棋子宽度
#define CHESS_HEIGTH				25									//棋子高度
#define NODE_WIDTH					32									//结点宽度
#define NODE_HEIGTH					31									//结点高度

#define ARROW_WIDTH					26									//箭头宽度
#define ARROW_HEIGTH				25									//箭头高度
