...
void CChessBorad::DrawBoard(CDC *pDC)
{
	...
	//绘画棋盘
	CImageHandle BoradHandle(&m_ImageBorad);
	m_ImageBorad.AlphaDrawImageEx(&BufferDC,0,0,RGB(0,0,0));
	//绘画箭头
	DrawArrow(&BufferDC) ;
    ...
    //                m_ImageChess.BitBlt(BufferDC.GetSafeHdc() , x*NODE_WIDTH+(NODE_WIDTH-CHESS_WIDTH)/2 , y*NODE_HEIGTH+(NODE_HEIGTH-CHESS_HEIGTH)/2 , 
				...
				if(CHESS_BACK==m_ChessBorad[x][y].bChessMode)
				{
					//m_ImageChess.AlphaDrawImage(&BufferDC,x*NODE_WIDTH+(NODE_WIDTH-CHESS_WIDTH)/2+24,y*NODE_HEIGTH+(NODE_HEIGTH-CHESS_HEIGTH)/2+33,CHESS_WIDTH , CHESS_HEIGTH,0 , (m_ChessBorad[x][y].bColor-1)*CHESS_HEIGTH,RGB(255,0,255));
					m_ImageChess.AlphaDrawImage(&BufferDC,x*NODE_WIDTH+(NODE_WIDTH-CHESS_WIDTH)/2,y*NODE_HEIGTH+(NODE_HEIGTH-CHESS_HEIGTH)/2,CHESS_WIDTH , CHESS_HEIGTH,0 , (m_ChessBorad[x][y].bColor-1)*CHESS_HEIGTH,RGB(255,0,255));
				}
				else{
					//m_ImageChess.AlphaDrawImage(&BufferDC,x*NODE_WIDTH+(NODE_WIDTH-CHESS_WIDTH)/2+24,y*NODE_HEIGTH+(NODE_HEIGTH-CHESS_HEIGTH)/2+33,CHESS_WIDTH , CHESS_HEIGTH,m_ChessBorad[x][y].bChessID*CHESS_WIDTH , (m_ChessBorad[x][y].bColor-1)*CHESS_HEIGTH,RGB(255,0,255));
					m_ImageChess.AlphaDrawImage(&BufferDC,x*NODE_WIDTH+(NODE_WIDTH-CHESS_WIDTH)/2,y*NODE_HEIGTH+(NODE_HEIGTH-CHESS_HEIGTH)/2,CHESS_WIDTH , CHESS_HEIGTH,m_ChessBorad[x][y].bChessID*CHESS_WIDTH , (m_ChessBorad[x][y].bColor-1)*CHESS_HEIGTH,RGB(255,0,255));
				}
			}
		}
