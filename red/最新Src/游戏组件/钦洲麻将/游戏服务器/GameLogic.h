...
#define CHK_QING_YI_SE				0x0010								//清色权位
#define CHK_QI_XIAO_DUI				0x0200								//七小对
//#define CHK_ONE_XIAO_DUI			0x0900								//清一色七小对
#define CHR_QIANG_GANG				0x2000								//抢杆权位
#define CHK_THIRTEEN_ONE			0x4000								//十三吆
...
public:
	...
	//七小对
	bool IsQiXiaoDui(BYTE cbCardIndex[MAX_INDEX], tagWeaveItem WeaveItem[], BYTE cbWeaveCount);
	//清一色七小对
//	bool IsOneColQiXiaoDui(BYTE cbCardIndex[MAX_INDEX], tagWeaveItem WeaveItem[], BYTE cbWeaveCount);
//	bool ThirteenOne(BYTE cbCardIndex[MAX_INDEX], tagWeaveItem WeaveItem[], BYTE cbWeaveCount);
