...
#define GAME_NAME					TEXT("新升级")						//游戏名字
...
#define SUB_S_RERANDCARD			109									//重新洗牌　
#define SUB_S_REQUIR_OPEN			110									//是否炒底
...
//是否炒底
struct CMD_S_RequirOpen
{
	WORD							wChairID;							//炒底玩家
};

#define	MIN_SCORE					15									//最小分数
...
#define SUB_C_RERANDCARD			5									//重新洗牌
#define SUB_C_OPENCONCEALCARD		6									//炒翻底牌
