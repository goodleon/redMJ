...
#define IDI_RERANDCARD					204								//重洗定时器
#define IDI_OPEN_CONCEAL				205								//炒底定时器
...
#define TIME_OPEN_CONCEAL				5								//炒底时间
...
bool CGameClientDlg::OnGameMessage(WORD wSubCmdID, const void * pBuffer, WORD wDataSize)
{
	...
	case SUB_S_RERANDCARD:     //重新洗牌
		{
			return OnSubReRandCard();
		}
	case SUB_S_REQUIR_OPEN:    //是否炒底
		{
