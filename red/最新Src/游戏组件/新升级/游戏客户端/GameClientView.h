...
#define IDM_RERANDCARD				(WM_USER+114)						//重新洗牌
#define IDM_OPENCONCEALCARD			(WM_USER+115)						//炒翻底牌
...
protected:
	...
	CSkinImage						m_ImageLeve1;					    //等级1
	CSkinImage						m_ImageLeve2;					    //等级2
	CSkinImage						m_ImageLeve3;						//等级3
	CSkinImage						m_ImageLeve4;						//等级4
	CSkinImage						m_ImageLeve5;						//等级5
	CSkinImage						m_ImageLeve6;						//等级6
...
public:
	...
	TransButton						m_btReRandCard;						//重新洗牌
	TransButton						m_btOpenConcealCard;				//炒翻底牌
	TransButton						m_btGiveUp;							//放弃炒底
...
public:
	...
	//埋底用户
	void SetPutConcealUser(WORD wPutConcealUser);
...
protected:
	...
	//重新洗牌
	afx_msg void OnReRandCard();
	//炒翻底牌
	afx_msg void OnOpenConcealCard();
	//放弃炒底
