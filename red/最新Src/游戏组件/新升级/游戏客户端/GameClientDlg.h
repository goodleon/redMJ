...
protected:
	...
	//重新洗牌
	bool OnSubReRandCard();
	//是否炒底
	bool OnSubRequirOpen(const void * pBuffer, WORD wDataSize);
...
protected:
	...
	//重新洗牌
	LRESULT OnReRandCard(WPARAM wParam, LPARAM lParam);
	//炒翻底牌
	LRESULT OnOpenConcealCard(WPARAM wParam, LPARAM lParam);
