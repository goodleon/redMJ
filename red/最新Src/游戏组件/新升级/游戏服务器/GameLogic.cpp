...
//const BYTE	CGameLogic::m_cbCardData[CELL_PACK]=
//{
//	0x4E,0x4E,0x4E,0x4E,0x4E,0x4E,0x4E,0x4E,0x4F,0x4F,0x4F,0x4F,0x4F,	//方块 A - K
//	0x4E,0x4E,0x4E,0x4E,0x4E,0x4E,0x4E,0x4E,0x4E,0x4E,0x4E,0x4E,0x4E,	//梅花 A - K
//	0x22,0x22,0x22,0x22,0x22,0x22,0x22,0x22,0x4E,0x4E,0x4E,0x4E,0x4E,	//红桃 A - K
//	0x32,0x32,0x32,0x32,0x32,0x32,0x32,0x32,0x32,0x32,0x4E,0x4E,0x4E,	//黑桃 A - K
//	0x4E,0x4F,
//};
...
// 牌面分数
WORD CGameLogic::GetCardTotalScore(const BYTE cbHandCardData[], BYTE cbHandCardCount)
{
	//变量定义
	WORD wTotalScore=0;
	BYTE bCardData;
	...
	{
		//转换数值
		bCardData =GetCardValue(cbHandCardData[i]);

		//判断分值
		if((bCardData==0x05)||(bCardData==0x0a)||(bCardData==0x0d))
			wTotalScore+=bCardData;		
	}
