...
protected:
	...
	bool							m_bEnableOpenConceal[GAME_PLAYER];	//炒底变量
	bool							m_bStartOpenConceal;				//开始炒底
...
protected:
	...
	//用户炒底
	bool OnUserOpenConcealCard(WORD wChairID, BYTE cbCallCard, BYTE cbCallCount);
