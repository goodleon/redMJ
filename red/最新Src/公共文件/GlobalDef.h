...
#define szProductName		TEXT("TatoGame娱乐平台")

#define szLessMoney		TEXT("加入游戏至少需要 %ld 的游戏币才能游戏，现在就获得游戏币吗！")

//注册主键
#define szSystemRegKey		TEXT("vGames")
...
//数据加密密钥
const static DWORD g_dwPacketKey=0xC77CC77C;//0x6CC66CC6;
...
#define MAIN_DLG_CLASSNAME				TEXT("TatoPlaza")				//窗口注册名
