...
public:
	...
	//获取大小
	virtual const CSize & __cdecl GetBigFaceSize() { return m_BigSize; }
	//绘画头像
	...
	//绘画头像
	virtual void __cdecl DrawBigFace(CDC * pDC, int nXPos, int nYPos, WORD wFaceID);
