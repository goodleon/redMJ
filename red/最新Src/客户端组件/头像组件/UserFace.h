...
//宏定义
#define LIT_FACE_WIDTH						24							//头像宽度
#define LIT_FACE_HEIGHT						24							//头像高度
#define NOR_FACE_WIDTH						34							//头像宽度
#define NOR_FACE_HEIGHT						34							//头像高度
#define BIG_FACE_WIDTH						55							//头像宽度
#define BIG_FACE_HEIGHT						55							//头像高度
