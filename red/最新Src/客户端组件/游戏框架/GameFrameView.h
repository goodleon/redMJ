...
private:
	...
	static CImage					m_ImageBuffer;						//缓冲位图
	static CImage					m_ImageBuffer2;						//缓冲位图2
...
public:
	...
	//绘画头像
	void DrawUserBigFace(CDC * pDC, WORD wFaceID, int nXPos, int nYPos, bool bOffLine);
	//绘画准备
