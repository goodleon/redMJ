...
#define IDC_BT_BUTTON_1						33333						//功能按钮
#define IDC_BT_BUTTON_2						33334						//功能按钮
#define IDC_BT_BUTTON_3						33335						//功能按钮
#define IDC_BT_BUTTON_4						33336						//功能按钮
#define IDC_BT_BUTTON_5						33337						//功能按钮
#define IDC_BT_TOOLSET						33338						//功能按钮
//////////////////////////////////////////////////////////////////////////
...
//功能按钮
void CGameFrameDlg::OnBnClickedButton1()
{//官方网站
...
//功能按钮
void CGameFrameDlg::OnBnClickedButton2()
{//金币充值
...
//功能按钮
void CGameFrameDlg::OnBnClickedButton3()
{//个人银行
...
//功能按钮
void CGameFrameDlg::OnBnClickedButton4()
{//金币兑换
	//g_GlobalUnits.GoWeb("/",true);
	return;
}
...
//功能按钮
void CGameFrameDlg::OnBnClickedButton5()
{//金币兑换
	//g_GlobalUnits.GoWeb("/",true);
	return;
}
...
CGameFrameDlg::~CGameFrameDlg()
{
	...
	SafeDelete(m_btButton1);
	SafeDelete(m_btButton2);
	SafeDelete(m_btButton3);
	SafeDelete(m_btButton4);
	SafeDelete(m_btButton5);
	SafeDelete(m_btToolSet);
...
void CGameFrameDlg::RectifyControl(int nWidth, int nHeight)
{
	...
	m_ToolBar->SetWindowPos(NULL,0,0,180,25,SWP_NOMOVE);
	//m_ToolBar->SetWindowPos(NULL,rc.left + 7,rc.bottom - 40,0,0,SWP_NOSIZE);
	m_ToolBar->SetWindowPos(NULL,rc.right-187,rc.bottom - 33,0,0,SWP_NOSIZE);
	...
	m_ChatMsgDlg->SetWindowPos(NULL,0,0,180,78,SWP_NOMOVE);
	//m_ChatMsgDlg->SetWindowPos(NULL,rc.left+7,rc.bottom - 114,0,0,SWP_NOSIZE);
	m_ChatMsgDlg->SetWindowPos(NULL,rc.right-187,rc.bottom - 107,0,0,SWP_NOSIZE);
	...
	DeferWindowPos(hDwp,m_btButton1->GetSafeHwnd(),NULL,311,6,0,0,uFlags|SWP_NOSIZE);
	DeferWindowPos(hDwp,m_btButton2->GetSafeHwnd(),NULL,311+nSpace,6,0,0,uFlags|SWP_NOSIZE);
	DeferWindowPos(hDwp,m_btButton3->GetSafeHwnd(),NULL,311+nSpace*2,6,0,0,uFlags|SWP_NOSIZE);
	DeferWindowPos(hDwp,m_btButton4->GetSafeHwnd(),NULL,311+nSpace*3,6,0,0,uFlags|SWP_NOSIZE);
	DeferWindowPos(hDwp,m_btButton5->GetSafeHwnd(),NULL,311+nSpace*4,6,0,0,uFlags|SWP_NOSIZE);
	DeferWindowPos(hDwp,m_btToolSet->GetSafeHwnd(),NULL,564,493,0,0,uFlags|SWP_NOSIZE);
...
BOOL CGameFrameDlg::OnInitDialog()
{
	...
	m_btButton1 = new CRgnButton();
	m_btButton2 = new CRgnButton();
	m_btButton3 = new CRgnButton();
	m_btButton4 = new CRgnButton();
	m_btButton5 = new CRgnButton();	
	m_btToolSet = new CRgnButton();
	...
	m_btButton1->Create(NULL,WS_CHILD|WS_VISIBLE,CRect(-999,0,0,0),this,IDC_BT_BUTTON_1);
	m_btButton2->Create(NULL,WS_CHILD|WS_VISIBLE,CRect(-999,0,0,0),this,IDC_BT_BUTTON_2);
	m_btButton3->Create(NULL,WS_CHILD|WS_VISIBLE,CRect(-999,0,0,0),this,IDC_BT_BUTTON_3);
	m_btButton4->Create(NULL,WS_CHILD|WS_VISIBLE,CRect(-999,0,0,0),this,IDC_BT_BUTTON_4);
	m_btButton5->Create(NULL,WS_CHILD|WS_VISIBLE,CRect(-999,0,0,0),this,IDC_BT_BUTTON_5);
	m_btToolSet->Create(NULL,WS_CHILD|WS_VISIBLE,CRect(-999,0,0,0),this,IDC_BT_TOOLSET);

	m_btButton1->LoadRgnImage(hInstance,IDB_FRAME_BT_BUTTON_1,0xff00ff);
	m_btButton2->LoadRgnImage(hInstance,IDB_FRAME_BT_BUTTON_2,0xff00ff);
	m_btButton3->LoadRgnImage(hInstance,IDB_FRAME_BT_BUTTON_3,0xff00ff);
	m_btButton4->LoadRgnImage(hInstance,IDB_FRAME_BT_BUTTON_4,0xff00ff);
	m_btButton5->LoadRgnImage(hInstance,IDB_FRAME_BT_BUTTON_5,0xff00ff);
	m_btToolSet->LoadRgnImage(hInstance,IDB_TOOLSET,0xff00ff);
	...
	m_btQuit->Create(NULL,WS_CHILD|WS_VISIBLE,CRect(735,10,0,0),this,IDB_BT_QUIT);
	m_btMax->Create(NULL,WS_CHILD|WS_VISIBLE,CRect(703,7,0,0),this,IDB_BT_MAX);
	m_btMin->Create(NULL,WS_CHILD|WS_VISIBLE,CRect(678,10,0,0),this,IDB_BT_MIN);
