                           ...
                           int nIconNormal)
{
	...
	UINT cch = wcslen(OptionText);
	LPSTR pszKey = (char*)_alloca(cch*2 + 1);
	cch = _wcstombsz(pszKey, OptionText, cch*2 + 1);
	CString junk=pszKey;
	free(pszKey);
...
#endif // DISABLE_INTERFACE_FUNCTION
