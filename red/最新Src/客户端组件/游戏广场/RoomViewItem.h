...
public:
	...
	TransButton						m_btSendChat;				//发送按钮

	CRgnButton						m_btExpression;				//表情按钮
	TransButton						m_btColorSet;				//颜色设置
	...
	CHtmlBrower						*m_pHtmlBrower2;		//浏览窗口

	//功能控件
public:
	CRgnButton						m_btAutoSit;				//加入按钮
	CRgnButton						m_btFindUser;				//查找按钮

	//用户控件
public:
	CTableFrame						m_TableFrame;				//桌子框架
	//CUserListView					m_UserListView;				//用户列表
	CImageListCtrl					m_UserListView;				//用户列表
...
public:
	...
	//左视图区
protected:
	CSkinButton					m_btRoom1;						//房间
	CSkinButton					m_btRoom2;						//房间
	CSkinButton					m_btRoom3;						//房间
	CSkinButton					m_btRoom4;						//房间
	CSkinButton					m_btRoom5;						//房间
	CSkinButton					m_btRoom6;						//房间
	CSkinButton					m_btRoomExit;						//房间

	CSkinImage					m_ImageTop;						//左边框
	CSkinImage					m_ImageInfo;					//左边框
	CSkinImage					m_ImageWeb;						//左边框
