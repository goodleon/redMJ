...
#define CONTROL_BAR_HEIGHT				10								//控制条高
...
public:
	...
	//资源变量
protected:
	CSkinImage							m_Frame_BL;					//图片资源
	CSkinImage							m_Frame_BM;					//图片资源
...
public:
	...
	CSkinButton							m_btPrisonSet;					//个人设置
	CSkinButton							m_btCompanion;					//关系管理
	CSkinButton							m_btChangeTheme;				//更换主题
...
public:
	...
	//bluker:进入房间,g_pControlBar->CreateRoomViewItem(7,7);
