...
/*
  --------------------------------------------------------------------------------
	...
	the initial developer3 or any other contributor) assume the cost of any necessary
...
/** \addtogroup Painting */ //@{
	...
	bool	CreateFromHDC(HDC hdc,RECT &rc);
	bool	TransparentBlt(CxImage &xImgSrc,BYTE nTransparePercent=0,COLORREF TransColor=-1,int x=0,int y=0,RECT *srcRc=NULL);
	bool	TransparentBlt(HDC hdc,BYTE nTransparePercent=0,COLORREF TransColor=-1,int x=0,int y=0,RECT *srcRc=NULL);
