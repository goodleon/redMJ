...
//宏定义
#define DEF_TITLEBORDER_COLOR		RGB(161,214,246)					//(标题边框)默认颜色
...
#define DEF_CAPTIONLINE_COLOR		RGB(200,18,63)						//(标题行)默认颜色

#define DEF_CAPTIONTX_COLOR			RGB(255,255,255)						//(标题)默认颜色
